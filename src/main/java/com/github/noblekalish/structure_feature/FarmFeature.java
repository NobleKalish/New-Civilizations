package com.github.noblekalish.structure_feature;
...
public class FarmFeature extends StructureFeature<DefaultFeatureConfig> {
    public FarmFeature(Codec<DefaultFeatureConfig> codec) {
        super(codec);
    }
    ...
    public static class Start extends StructureStart<DefaultFeatureConfig> {
        ...
        public void init(DynamicRegistryManager registryManager, ChunkGenerator chunkGenerator, StructureManager manager, int chunkX,
            ...
            FarmGenerator.addPieces(manager, pos, rotation, this.children);
